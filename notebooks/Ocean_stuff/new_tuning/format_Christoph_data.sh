...
cdo setgrid,$path2/variables_of_interest-"$nemo_run"_"$yy".nc $path1/domain_cfg_eANT025.L121.nc $path2/domain_cfg_eANT025.L121_setgrid.nc
...
cdo sellonlatbox,0,360,-90,-50 $path2/domain_cfg_eANT025.L121_setgrid.nc $path3/mask_variables_of_interest_Ant.nc
